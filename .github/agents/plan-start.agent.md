...
agents: ["Code Explorer", "Architecture Researcher", "Database Analyst", "Security Analyst", "Test Analyzer", "Cross Platform Specialist", "Design System Researcher", "Dependency Researcher", "DevOps Specialist", "Integration Researcher", "Planning Coordinator", "Planner", "ADR Writer"]
model: "Claude Sonnet 4.6 (copilot)"
handoffs:
  - label: "✅ Validate Plan"
    agent: Plan Validate
    prompt: "Validate the implementation plan that was just produced."
    send: false
---
...
When done, use the **✅ Validate Plan** button below to transition to Plan Validate.
...
decisions: tell the user "Plan complete — click **✅ Validate Plan** to validate it."
...
- Plan Validate (`@plan-validate`) — validate the plan produced here
- Plan Execute (`@plan-execute`) — execute the validated plan
