...
agents: ["Security Reviewer", "DB Migration Reviewer", "Performance Reviewer", "Design System Reviewer", "UX Reviewer", "Cross Platform Reviewer", "Native App Reviewer", "Integration Reviewer"]
model: "Claude Sonnet 4.6 (copilot)"
handoffs:
  - label: "▶️ Execute Plan"
    agent: Plan Execute
    prompt: "Execute the validated plan."
    send: false
---
...
When done, use the **▶️ Execute Plan** button below to transition to Plan Execute.
...
Click **▶️ Execute Plan** to execute."
...
- Plan Start (`@plan-start`) — produces the plan validated here
- Plan Execute (`@plan-execute`) — executes the validated plan
